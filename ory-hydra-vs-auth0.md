...
## High-Level Overview
| Feature | Ory Hydra | Auth0 |
|--------|-----------|--------|
| Type | Open-source OAuth2/OIDC server | SaaS Identity Platform |
| Where it runs | Self-hosted (your infra) | Auth0 cloud |
| Pricing | Free (open source) | Subscription-based |
| Control level | Full control | Vendor-controlled |
