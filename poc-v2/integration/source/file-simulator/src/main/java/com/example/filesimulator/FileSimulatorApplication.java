package com.example.filesimulator;
...
public class FileSimulatorApplication implements CommandLineRunner {

    private static final Logger log = LoggerFactory.getLogger(FileSimulatorApplication.class);

    private final KafkaTemplate<String, String> kafkaTemplate;
    private final ObjectMapper mapper = new ObjectMapper();
    private final Random random = new Random();

    private static final String TOPIC = "sales-file";
    ...
    private static final String[] DESCRIPTIONS = {"Widget Alpha", "Service Beta", "Product Gamma", "Solution Delta", "Package Epsilon"};

    public FileSimulatorApplication(KafkaTemplate<String, String> kafkaTemplate) {
        this.kafkaTemplate = kafkaTemplate;
    }

    public static void main(String[] args) {
        SpringApplication.run(FileSimulatorApplication.class, args);
    }

    @Override
    public void run(String... args) throws Exception {
        long saleId = 10000;
        log.info("File Simulator started. Producing events to topic: {}", TOPIC);
